    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(unique=True, max_length=255, verbose_name=b'email address', error_messages={b'unique': b'A user with that email address already exists'})),
                ...
                ('user_type', models.IntegerField(choices=[(1, b'Intern'), (2, b'Organization')])),
            ...
            bases=(models.Model, common.model_permissions.IsAuthOrReadOnlyAndCreate),
        ),
    ]
